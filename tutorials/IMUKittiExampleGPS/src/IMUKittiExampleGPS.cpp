...
void loadKittiData(KittiCalibration& kitti_calibration,
    ...
    std::cout <<"-- Reading sensor metadata\n" << std::endl;
...
//    string gps_data_file = findExampleDataFile("KittiGps_converted.txt");
    ...
    {
        ifstream gps_data(gps_data_filename.c_str());
...
po::variables_map parseOptions(int argc, char* argv[]) {
    ...
    desc.add_options()("help,h", "produce help message")
            ("imu_meta_data_csv_path","path to imu_meta_data")
            ("imu_data_csv_path","path to imu measurement data")
            ("gps_data_csv_path","path to gps measurement data");
