...
int main(int argc, char* argv[]) {
    ...
    data_filename = var_map["data_csv_path"].as<string>();
    ...
    int no_of_imu_readings = 0;
    int no_of_gps_readings = 0;
    while (file.good()) {
...
//                 << "Angular error:" << current_orientation_error << "\n";
            ...
            output_time += 1.0;
            no_of_gps_readings++;
            std::cout << "No of imu readings: " << no_of_imu_readings << std::endl;
            std::cout << "No of gps readings: " << no_of_gps_readings << std::endl;
        } else {
