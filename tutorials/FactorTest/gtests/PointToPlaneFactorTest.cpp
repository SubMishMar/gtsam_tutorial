...
//    // Create a factor
//    lin_estimator::PointToPlaneFactor Factor(X(0), X(1), V(1), C(0), preintimumeasurements, plane_params, lidar_point, weight, noise_model);
//
...
//    = boost::bind(&lin_estimator::PointToPlaneFactor::evaluateError, Factor, _1, _2, _3, _4, boost::none, boost::none, boost::none, boost::none);
//
